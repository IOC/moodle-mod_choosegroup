...
/**
 * choosegroup backup task that provides all the settings and steps to perform one
 * complete backup of the activity
 */
class backup_choosegroup_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new backup_choosegroup_activity_structure_step('choosegroup_structure', 'choosegroup.xml'));
    }
